...
def main_batch():
    ...
    # 存放所有处理后 PNG 帧的根目录
    ROOT_OUTPUT_FRAME_DIR = '/home/lizize/pyVHR_for_ISP/ISPpipline/isp_output_frame/baseenvironment_baselineISP'
    
    # 存放最终输出视频和 JSON 参数文件的根目录
    ROOT_OUTPUT_VIDEO_DIR = 'Data_for_pyVHR/isp_output_Video/baseenvironment_baselineISP'

    # 确保视频输出的大文件夹存在
    os.makedirs(ROOT_OUTPUT_VIDEO_DIR, exist_ok=True)

    # input_folder = 'ISPpipline/raw_data/raw_lzz' # 存放RAW序列的文件夹
    # output_folder = '/home/lizize/pyVHR_for_ISP/ISPpipline/isp_output_frame/ISP_test'   # 存放处理后PNG帧的文件夹
    
    # output_video_path = 'Data_for_pyVHR/isp_output_Video/AHD_test/output_video_framewell_8bit.mkv' # 最终输出视频的路径
